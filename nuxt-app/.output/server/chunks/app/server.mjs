...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_slug_-e1740275.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-27918d1f.mjs').then((m) => m.default || m)
  },
  {
    name: "room-slug",
    path: "/room/:slug",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-86bfb7d4.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="loading"><div class="container"><div class="loading__spinner"><div class="funspinner__box"><div class="linesquare"><b></b><b></b><b></b><b></b><b></b></div></div></div></div></div>`);
