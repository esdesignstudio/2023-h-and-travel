import { b as __nuxt_component_0$1$1, c as __nuxt_component_0$3 } from './titleDouble-c2ec469f.mjs';
import _sfc_main$a from './nuxt-icon-e392c362.mjs';
import { useSSRContext, ref, mergeProps, resolveDirective, withCtx, createTextVNode, createVNode } from 'vue';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrGetDirectiveProps } from 'vue/server-renderer';
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><p>${ssrInterpolate(`${__props.data.like} likes`)}</p><p>${ssrInterpolate(__props.data.text)}</p><p>${ssrInterpolate(__props.data.s_text)}</p></div></div>`);
    };
  }
};
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        style: { backgroundImage: "url(" + ((_b = (_a = __props.data) == null ? void 0 : _a.bg_img) == null ? void 0 : _b.url) + ")" }
      }, _attrs))}><div class="flexible-ig-show__bg"></div><div class="flexible-ig-show__wrapper"><div class="flexible-ig-show__wrapper-title"><p${ssrRenderAttrs(mergeProps(ssrGetDirectiveProps(_ctx, _directive_inview), ssrGetDirectiveProps(_ctx, _directive_fade)))}>${ssrInterpolate((_c = __props.data) == null ? void 0 : _c.title)}</p>`);
      _push(ssrRenderComponent(_component_ElementsDecoTitle, {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList((_a = __props.data) == null ? void 0 : _a.block, (item, key) => {
        ...
        if (item == null ? void 0 : item.deco_title) {
          ...
          _push(`<span${ssrRenderAttrs(mergeProps(ssrGetDirectiveProps(_ctx, _directive_inview), ssrGetDirectiveProps(_ctx, _directive_fade)))}>${ssrInterpolate(key + 1 > 9 ? key + 1 : `0${key + 1}`)}</span>`);
        }
...
//# sourceMappingURL=titleBigImg-c217eb89.mjs.map
