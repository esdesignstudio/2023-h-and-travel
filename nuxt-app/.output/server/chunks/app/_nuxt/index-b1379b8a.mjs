...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if ((_g = unref(global)) == null ? void 0 : _g.footer.phone) {
        _push(`<p${ssrRenderAttrs(mergeProps(ssrGetDirectiveProps(_ctx, _directive_inview), ssrGetDirectiveProps(_ctx, _directive_fade)))}>${ssrInterpolate(`\u96FB\u8A71\uFF5C${(_h = unref(global)) == null ? void 0 : _h.footer.phone}`)}</p>`);
      } else {
        _push(`<!---->`);
      }
      if ((_i = unref(global)) == null ? void 0 : _i.footer.address) {
        _push(`<p${ssrRenderAttrs(mergeProps(ssrGetDirectiveProps(_ctx, _directive_inview), ssrGetDirectiveProps(_ctx, _directive_fade)))}>${ssrInterpolate(`\u5730\u5740\uFF5C${(_j = unref(global)) == null ? void 0 : _j.footer.address}`)}</p>`);
      } else {
        _push(`<!---->`);
      }
      if ((_k = unref(global)) == null ? void 0 : _k.footer.email) {
        _push(`<p${ssrRenderAttrs(mergeProps(ssrGetDirectiveProps(_ctx, _directive_inview), ssrGetDirectiveProps(_ctx, _directive_fade)))}>${ssrInterpolate(`\u4FE1\u7BB1\uFF5C${(_l = unref(global)) == null ? void 0 : _l.footer.email}`)}</p>`);
      } else {
        _push(`<!---->`);
      }
      ...
      ssrRenderList((_n = (_m = unref(global)) == null ? void 0 : _m.footer) == null ? void 0 : _n.socials, (item, key) => {
        var _a2, _b2;
      ...
      _push(`</span><p>${ssrInterpolate((_p = (_o = unref(global)) == null ? void 0 : _o.footer) == null ? void 0 : _p.copyright)}</p></div></div><div class="footer__bottom-marquee"><!--[-->`);
...
//# sourceMappingURL=index-b1379b8a.mjs.map
