import { _ as __nuxt_component_0$1, a as __nuxt_component_1$1, b as __nuxt_component_2, c as __nuxt_component_3, d as __nuxt_component_4, e as __nuxt_component_5, f as __nuxt_component_6, g as __nuxt_component_7 } from './titleBigImg-5ff92bc2.mjs';
import { _ as __nuxt_component_4$1, a as __nuxt_component_3$1 } from './titleDouble-507383b1.mjs';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList((_d = (_c = unref(pageData)) == null ? void 0 : _c.data) == null ? void 0 : _d.flex, (flex, key) => {
        _push(`<section class="${ssrRenderClass([{ isbg: flex.acf_fc_layout === "ig_show" }, "page-index__flex"])}">`);
...
//# sourceMappingURL=index-d024f4ac.mjs.map
