...
const styles = {
  ...
  "pages/room/index.vue": () => import('./_nuxt/index-styles.df0da6de.mjs').then(interopDefault),
  ...
  "components/flexible/roomFacilities.vue": () => import('./_nuxt/roomFacilities-styles.690bc475.mjs').then(interopDefault),
