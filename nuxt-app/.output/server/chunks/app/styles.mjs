...
const styles = {
  "app.vue": () => import('./_nuxt/app-styles.7cb2d509.mjs').then(interopDefault),
  ...
  "pages/privacy.vue": () => import('./_nuxt/privacy-styles.5ffdbf1a.mjs').then(interopDefault),
  "pages/room/[slug].vue": () => import('./_nuxt/_slug_-styles.a337399f.mjs').then(interopDefault),
  "pages/room/index.vue": () => import('./_nuxt/index-styles.c55a5197.mjs').then(interopDefault),
  ...
  "components/elements/roomList.vue": () => import('./_nuxt/roomList-styles.81edbd1f.mjs').then(interopDefault),
