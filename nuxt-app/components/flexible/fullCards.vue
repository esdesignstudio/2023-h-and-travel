<template>
    <div class="flexible-full-cards">
        <figure class="flexible-full-cards__bg">
            <img
                :src="data?.image?.url"
                :alt="data?.image?.alt"
            />
        </figure>
        <div class="flexible-full-cards__wrapper container">
            <div class="flexible-full-cards__wrapper-title">
                <div class="flexible-full-cards__wrapper-title-deco">
                    <ElementsDecoTitle :data="data?.deco_title"/>
                </div>
                <h3 v-text="data?.title"></h3>
            </div>
            <div
                class="flexible-full-cards__wrapper-description"
                v-html="data?.des"
            ></div>
        </div>
    </div>
